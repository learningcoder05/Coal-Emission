          ...
          {!submitted ? (
            ...
            <div className="space-y-6 animate-fadeIn">
              ...
              <Card className="bg-gray-800 border-gray-700 animate-slideInFromBottom" style={{animationDelay: '0.3s'}}>
                <CardHeader>
                  <h2 className="text-2xl font-semibold text-blue-300 text-center">Consultation Services</h2>
                </CardHeader>
                <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {[
                    { title: 'Remote Consultation', price: 'Rs. 5000', description: 'Expert analysis via video conference' },
                    { title: 'On-Site Assessment', price: 'Not decided', description: 'Comprehensive on-location evaluation' },
                  ].map((service, index) => (
